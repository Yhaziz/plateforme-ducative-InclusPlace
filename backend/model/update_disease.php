...
if(isset($_GET["do"])&&($_GET["do"]=="update_disease")){
	...
	if($name == $name1 && $id == $id1){//MSK-000143-U-1
		if($student_count != $student_count1 ){//MSK-000143-U-2
			...
			$sql1 = "update disease set name='".$name."',student_count='".$student_count."' where id='$id'";
			...
			if(mysqli_query($conn,$sql1)){
				...
				$sql2="SELECT * FROM disease where id='$id'";	
		...
		if($name == $name1){
			...
			$msg+=4;
			//MSK-000143-U-8 The disease is duplicated
