...
if(isset($_POST["do"])&&($_POST["do"]=="update_student_profile")){
	...
	if(!$name){
		...
		$sql = "update student set fname='".$fname."',surname='".$surname."', gender='".$gender."',address='".$address."', téléphone='".$téléphone."',email='".$email."' where id='$id'";
		
		if(mysqli_query($conn,$sql)){
			
			$sql5 = "update parents set surname='".$g_name."',address='".$g_address."', téléphone='".$g_téléphone."',email='".$g_email."' where my_son_index='$my_son_index_number'";
		...
		if(move_uploaded_file($tmpname, $image_path)){
			...
			$sql = "update student set fname='".$fname."',surname='".$surname."', gender='".$gender."',address='".$address."', téléphone='".$téléphone."',email='".$email."',image_name='".$image_path."' where id='$id'";
