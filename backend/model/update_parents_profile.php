...
if(isset($_POST["do"])&&($_POST["do"]=="update_parents_profile")){
	...
	if(!$name){
		...
		$sql = "update parents set fname='".$fname."',surname='".$surname."', gender='".$gender."',address='".$address."', téléphone='".$téléphone."',email='".$email."' where id='$id'";
		...
		if(move_uploaded_file($tmpname, $image_path)){
			...
			$sql = "update parents set fname='".$fname."',surname='".$surname."', gender='".$gender."',address='".$address."', téléphone='".$téléphone."',email='".$email."',image_name='".$image_path."' where id='$id'";
