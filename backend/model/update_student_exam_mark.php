...
header("Location: view/my_student_exam_marks.php?do=alert_from_update&msg=$msg&exam=$exam_id&current_year=$current_year&my_index=$my_index&classroom=$classroom_id");
}
?>