...
if(isset($_POST["do"])&&($_POST["do"]=="update_teacher")){
	...
	if($email == $email1 && $id == $id1){//MSK-000143-U-1
		...
		if($cin != $cin1 || $fname != $fname1 || $surname != $surname1 || $email != $email1|| $facebook != $facebook1|| $instagram != $instagram1|| $linkedin != $linkedin1 || $spec != $spec1 || $address != $address1 || $gender != $gender1 ||$téléphone != $téléphone1 || $name){//MSK-000143-U-2		
			
			if(!$name){//MSK-000143-U-3
				$sql = "update teacher set cin='".$cin."', fname='".$fname."',surname='".$surname."',spec='".$spec."',address='".$address."',gender='".$gender."',téléphone='".$téléphone."' ,email='".$email."',facebook='".$facebook."',instagram='".$instagram."',linkedin='".$linkedin."' where id='$id'";
				...
				if(move_uploaded_file($tmpname, $image_path)){ //MSK-000143-U-7
					$sql = "update teacher set  cin='" . $cin . "', fname='" . $fname . "',surname='" . $surname . "',spec='" . $spec . "',address='" . $address . "',gender='" . $gender . "',téléphone='" . $téléphone . "' ,email='" . $email . "' ,facebook='" . $facebook. "' ,instagram='" . $instagram. "' ,linkedin='" . $linkedin . "',image_name='" . $image_path . "' where id='$id'";
		...
		if($email == $email1){
			...
			if(!$name){//MSK-000143-U-15
				...
				$sql = "update teacher set  cin='".$cin."', fname='".$fname."',surname='".$surname."',spec='".$spec."',address='".$address."',gender='".$gender."',téléphone='".$téléphone."' ,email='".$email."',facebook='".$facebook."',instagram='".$instagram."',linekdin='".$linkedin."' where id='$id'";
				...
				if(move_uploaded_file($tmpname, $image_path)){//MSK-000143-U-19	
                    ...
                    $sql = "update teacher set  cin='".$cin."', fname='".$fname."',surname='".$surname."',spec='".$spec."',address='".$address."',gender='".$gender."',téléphone='".$téléphone."' ,email='".$email."',facebook='".$facebook."',facebook='".$facebook."',linkedin='".$linkedin."',image_name='".$image_path."' where id='$id'";
