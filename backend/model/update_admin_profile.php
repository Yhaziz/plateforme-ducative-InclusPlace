...
if(isset($_POST["do"])&&($_POST["do"]=="update_admin_profile")){
	...
	if(!$name){
		...
		$sql = "update admin set fname='".$fname."',surname='".$surname."', gender='".$gender."',address='".$address."',email='".$email."' where id='$id'";
		...
		if(move_uploaded_file($tmpname, $image_path)){
			...
			$sql = "update admin set fname='".$fname."',surname='".$surname."', gender='".$gender."',address='".$address."',email='".$email."',image_name='".$image_path."' where id='$id'";
