...
include_once('../controller/config.php');
	...
	$sql3="SELECT * FROM student_classroom WHERE index_number='$index'";
	...
	while($row1=mysqli_fetch_assoc($result1)){
		...
		$sql4="INSERT INTO student_payment_history (index_number,classroom_id,subject_id,teacher_id,subject_fee,subtotal,_status,invoice_number,month,year,date) 
			   VALUES ( '".$index."','".$classroom_id."','".$subject_id."','".$teacher_id."','".$subject_fee."','".$subject_fee."','Monthly Fee','".$invoice_number."','".$current_month."','".$current_year."','".$current_date."')";
