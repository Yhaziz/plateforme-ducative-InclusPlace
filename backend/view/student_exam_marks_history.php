...
//MSK-000109
	...
	if(year == 'Select Year' || exam == 'Select Exam' || classroom == 'Select Classroom'){
    	...
    	xhttp.open("GET", "show_student1.php?exam="+exam  +  "&year="+year +  "&my_index="+my_index +  "&classroom="+classroom, true);												
