...
<div class="content-wrapper">
    ...
    <section class="content" > <!-- Start of table section -->
        <div class="row" id="table1"><!-- after delete methanata thamay overite karanne view_disease table -->
            <div class="col-md-8">
                <div class="box">
                		...
                		<div class="panel">
                			...
                			<form action="../index.php" method="post" enctype="multipart/form-data" id="form2">
								...
								<div class="form-group" id="divCinUpdate">
									...
									<div class="form-group" id="divFacebookUpdate">
                                        <label for="">Facebook</label>
                                        <input class="form-control " type="text" id="facebook1" name="facebook" autocomplete="off">
                                    </div>
									<div class="form-group" id="divInstagramUpdate">
                                        <label for="">Instagram</label>
                                        <input class="form-control " type="text" id="instagram1" name="instagram" autocomplete="off">
                                    </div>
									<div class="form-group" id="divLinkedinUpdate">
                                        <label for="">Linkedin</label>
                                        <input class="form-control " type="text" id="linkedin1" name="linkedin" autocomplete="off">
                                    </div>
									<div class="form-group" id="divSpecUpdate">
                                        <label for="">What is your pedagogical specialty?</label>
	...
	var xhttp = new XMLHttpRequest();//MSK-00116-Ajax Start
  		xhttp.onreadystatechange = function() {
    		if (this.readyState == 4 && this.status == 200) {
				...
				document.getElementById("spec1").value =myArray1[4];
                document.getElementById("gender1").value =myArray1[5];
				document.getElementById("address1").value =myArray1[6];
				document.getElementById("téléphone1").value =myArray1[7];
				document.getElementById("email1").value =myArray1[8];
				document.getElementById("facebook1").value =myArray1[9];
				document.getElementById("instagram1").value =myArray1[10];
				document.getElementById("linkedin1").value =myArray1[11];
				document.getElementById("output1").src ='../'+myArray1[12];
...
//MSK-000098-form2 submit
	...
	var surname = document.getElementById("spec1").value;
	...
	if(fname == '' || surname == '' || address == '' || téléphone == '' || email == '' || gname == '' || gaddress == '' || gtéléphone == '' || gemail == '' ||telformat.test(téléphone) == false || mailformat.test(email) == false ){
	...
	var xhttp = new XMLHttpRequest();
  		xhttp.onreadystatechange = function() {
    		...
    		if (this.readyState == 4 && this.status == 200) {
				...
				if(cSalary == 0){
					document.getElementById('currentSalary').innerHTML = "You have not any disease..!";
