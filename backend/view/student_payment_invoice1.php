          			...
          			<div class="panel panel-info"><!--panel -->
            			...
            			<div class="panel-body"><!--panel-body -->
                        	<div class="row " id="msk12345">
                            	<div class="col-xs-2">
                                	<div class="div-logo">
                                    	<img class="logo" src="../uploads/icon.png">
                                    </div>
                                </div>
                                <div class="col-xs-5 class-name">
                                    ...
                                    AV.Hedi Nouira <br>
                                    Immeuble jasmin médical 5ème étage B 502
                                    </div>
                                </div>
                                <div class="col-xs-4 class-email text-right ">
                                    	Email: inclu@gmail.com<br>
                                        téléphone:  +216 27 113 140 <br> 
                                </div>
                        	</div>
                            <div class="row ">
                                <div class="col-xs-5">
...
$sql2="select classroom.admission_fee as adm_fee
	   from student_classroom 
	   inner join classroom
	   on student_classroom.classroom_id=classroom.id
	   inner join student_payment
	   on student_classroom.index_number=student_payment.index_number
	   where student_classroom.index_number='$index' and student_classroom.year='$year' and student_payment.date='$date' and student_payment._status='Admission Fee'";
...
?>                                    
                                  <span class="std-name"><?php echo $name; ?></span><br>
                                     AV.Hedi Nouira _ Immeuble jasmin médical 5ème étage B 502
                                    </div>
                                </div>
                             ...
                             <table class="table table-bordered">
                                <thead>
                                    ...
                                    <th class="col-md-1">Amount(TND)</th>
								...
								<tbody>
                                	<tr id="tr_adm_fee">
                                    	<td>1</td>
                                       	<td>Admission Fee</td>
                                        <td><?php echo $admission_fee; ?>&nbsp;TND</td>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $monthly_fee; ?>&nbsp;TND</td>
                                        <td><?php echo $month; ?></td>
                                        <td><?php echo $date; ?></td>
                                    </tr>
                 				</tbody>
                             ...
                             <div class="row">
                                <div class="col-xs-1 text-right pdetail1">
                                      <strong>
                                        <span id="spanaFee"><?php echo $admission_fee; ?>&nbsp;TND</span> 
                                        <span id="spanmFee"><?php echo $monthly_fee; ?>&nbsp;TND</span> <br>
										<span id="spanTotal"><?php echo $total; ?>&nbsp;TND</span> <br>
                                        <span id="spanPaid"><?php echo $total; ?>&nbsp;TND</span> <br>
                                      </strong>
  								</div>
