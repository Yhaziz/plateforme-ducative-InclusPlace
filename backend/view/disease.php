              	...
              	<div class="box box-primary">
                	...
                	<form role="form" action="../index.php" method="post">             
						<div class="box-body">
                			<div class="form-group" id="divName">
                    			<label for="">Name</label>
                      			<input type="text" class="form-control" id="name" placeholder="Enter disease name" name="name" autocomplete="off">                    
                    		</div>
                		...
                		<div class="box-footer">
                  			<input type="hidden" name="do" value="add_disease" />
...
//MSK-000143-6-PHP-JS-INSERT
	...
	if($msg==1){
		echo"
			...
			var myModal = $('#disease_Duplicated');
			myModal.modal('show');
        	...
        	<div class="col-md-8">
            	<div class="box">
                	<div class="box-header">
                  		<h3 class="box-title">All disease</h3>
                	</div><!-- /.box-header -->
...
<?php
$sql1="SELECT * FROM timetable WHERE disease_id='$id'";	
...
$sql2="SELECT * FROM exam_timetable WHERE disease_id='$id'";	   
                		...
                		<div class="panel">
        					<div class="panel-heading bg-orange">               
        						<button type="button" class="close" data-dismiss="modal" aria-hidden="true"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></button>
          						<h4 class="modal-title custom_align" id="Heading">Edit disease</h4>
   							</div>
                            ...
                            <div class="panel-footer bg-gray-light">
                                ...
                                <button type="button" onClick="Updatedisease(this)" id="btnSubmit1" class="btn btn-info" style="width: 100%;"><span class="glyphicon glyphicon-ok-sign"></span> Update</button>
                            </div><!--/.panel-footer-->  
            			</div><!--/.panel--> 
            		</div><!--/.col-md-6-->
            	</div><!--/.row-->                                    
...
//MSK-00104
    ...
    xhttp.open("GET", "../model/get_disease.php?id=" + Id , true);												
...
//MSK-000108
	...
	if(name1 == '' || student_count1 == '' ){
		...
		var xhttp = new XMLHttpRequest();//MSK-00111-Ajax Start  
  			...
  			xhttp.open("GET", "../model/update_disease.php?id=" + Id1 + "&name="+name1 + "&student_count="+student_count1  +  "&do="+do1, true);												
...
//MSK-000126
	...
	var table_name= "disease";//give data table name
    		...
    		if (this.readyState == 4 && this.status == 200) {
				...
				if(myArray[0]==1){//MSK-000130
					...
					var xhttp1 = new XMLHttpRequest();//MSK-000131-Start Ajax  
						...
						xhttp1.open("GET", "show_disease_table.php" , true);												
