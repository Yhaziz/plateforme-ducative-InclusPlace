...
while($row=mysqli_fetch_assoc($result)){
	...
	if($user_index==$my_index){
		...
		if($user_type == "Parent"){
			...
			$sql1="select * from parent where index_number='$user_index'";
		...
		if($user_type == "Doctor"){
			...
			$sql1="select * from doctor where index_number='$user_index'";
		...
		if($user_type == "Avs"){
			...
			$sql1="select * from avs where index_number='$user_index'";
...
?>
            ...
            <div class="">
			<input type="text" class="form-control" id="msg" name="msg" placeholder="Enter your message">
