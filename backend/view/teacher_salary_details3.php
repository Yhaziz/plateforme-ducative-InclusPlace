...
$sql="select classroom.name as g_name,classroom.hall_charge as h_charge,subject.name as s_name,teacher_salary_history.subject_fee as s_fee,teacher_salary_history.subtotal as s_sub,teacher_salary_history.student_count as s_count
      from teacher_salary_history 
	  inner join classroom
	  on teacher_salary_history.classroom_id=classroom.id
	  inner join subject
