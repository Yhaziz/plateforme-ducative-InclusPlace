...
$sql="select DISTINCT subject_routing.subject_id as s_id,subject.name as s_name
      ...
      where subject_routing.classroom_id=$g_id";
...
$g_id=$_GET['classroom'];
$s_id=$_GET['subject'];
$sql="select DISTINCT subject_routing.teacher_id as t_id,teacher.surname as t_name
      from subject_routing
      inner join subject
      on subject_routing.subject_id=subject.id 
	  inner join teacher
      on subject_routing.teacher_id=teacher.id
      where subject_routing.classroom_id=$g_id and subject_routing.subject_id=$s_id";
...
<?php }} ?> 	           
            				...
            				<div class="panel-footer bg-gray-light">
                            	<input type="hidden" name="classroom" value="<?php echo $g_id; ?>"  />
