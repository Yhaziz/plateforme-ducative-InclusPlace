...
$sql1="SELECT * FROM student_classroom WHERE index_number='$index' and year='$year'";
$result1=mysqli_query($conn,$sql1);
$row1=mysqli_fetch_assoc($result1);
$id=$row1['classroom_id'];
...
$sql2="SELECT * FROM exam_range_classroom WHERE classroom_id='$id' and '$marks1' > _from and '$marks1' <= _to ";
				
$result2=mysqli_query($conn,$sql2);
$row2=mysqli_fetch_assoc($result2);
$mark_classroom=$row2['mark_classroom'];

if($row['se_marks']=="Absent"){
	$mark_classroom="Absent";
}
