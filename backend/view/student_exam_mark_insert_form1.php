...
$sql="select subject.id as s_id,subject.name as s_name
	  ...
	  where student_subject.index_number='$std_index' and student_subject.year='$current_year' and student_subject._status='' and  	subject_routing.classroom_id='$classroom_id'";
