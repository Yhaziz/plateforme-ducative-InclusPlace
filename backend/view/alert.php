	...
	<!--Warnning! - disease is Duplicated-->
	<div class="modal fade" id="disease_Duplicated" tabindex="-1" role="dialog" aria-labelledby="insert_alert1" aria-hidden="true">
    	<div class="modal-dialog">    
      		<div class="modal-content">
        		...
        		<div class="modal-body bgColorWhite">
        			<strong style="color:red; font-size:14px">Warnning!</strong> This disease is already have in our Database.
        		</div>
			</div>
		</div>
	</div><!--/.Modal-->
  	...
  	<div class="modal fade" id="duplicate_Record2" tabindex="-1" role="dialog" aria-labelledby="insert_alert1" aria-hidden="true">
    	<div class="modal-dialog">    
      		<div class="modal-content">
        		...
        		<div class="modal-body bgColorWhite">
        			<strong style="color:red; font-size:14px">Warnning!</strong> At this time there already have class, in that disease. 
        		</div>
      		</div>
    	</div>
	</div><!--/.Modal-->
