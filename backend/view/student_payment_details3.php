...
?>                                
                                    ...
                                    <table class="table table-bordered table-striped">
                                        <thead>
                                            ...
                                            <th class="col-md-1">Subject Fee(TND)</th>
                                            <th class="col-md-1 ">Total(TND)</th>
                                        </thead>
                                        <tbody id="tBody">
<?php
include_once('../controller/config.php');
...
$sql="select classroom.name as g_name,subject.name as s_name,student_payment_history.subject_fee as s_fee 
      from student_payment_history
	  inner join classroom
	  on student_payment_history.classroom_id=classroom.id
	  inner join subject
