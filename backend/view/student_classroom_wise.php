...
?>   
                	<tr>
                        ...
                        <td> 
<!--MSK-00113 -->                                     
<a href="edit_student.php?std_index=<?php echo $row["std_index"]; ?>&classroom_id=<?php echo $classroom_id; ?>" onClick="" class="btn btn-info btn-xs" data-id="<?php echo $row["std_id"]; ?>" data-toggle="modal">Edit</a>
<!--MSK-00128 -->
