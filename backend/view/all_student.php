            ...
            <div class="col-xs-6"><!-- left column -->
              	<div class="box box-primary"><!-- general form elements -->
                	<div class="box-header with-border">
                  		<h3 class="box-title">Select Classroom</h3>
                	</div><!-- /.box-header -->
                  	...
                  	<div class="box-body" >
                  		<div class="form-group" id="divGender">
                    		...
                    		<div class="col-xs-4" id="divGender1">
                    			<select name="classroom" class="form-control" id="classroom" ><!--MSK-000107-->
...
//MSK-000109	
    ...
    xhttp.open("GET", "student_classroom_wise.php?classroom="+classroom , true);												
  	xhttp.send();//MSK-000110-End Ajax
	
};

function CPageClassroom(classroom,page){
//MSK-000125
...
function CPageClassroom1(classroom){
//MSK-000125
...
$classroom=$_GET['classroom'];
	...
	if($msg==2){
		...
		echo '<script>','CPageClassroom1('.$classroom.');','</script>';
  		...
  		xhttp.onreadystatechange = function() {
    		...
    		if (this.readyState == 4 && this.status == 200) {
				...
				if(myArray[0]==1){//MSK-000136
					...
					CPageClassroom(classroom,page);//MSK-000138
	...
	var xhttp = new XMLHttpRequest();//MSK-00149-Start Ajax  
  		xhttp.onreadystatechange = function() {
    		if (this.readyState == 4 && this.status == 200) {
				...
				document.getElementById("g_téléphone2").innerHTML =myArray1[10];
				document.getElementById("g_email2").innerHTML =myArray1[11];
			
				$('#id4').data('id',myArray1[0]+','+classroom);		
			...
			<div class="container col-lg-6 msk-modal-content"><!--modal-content --> 
      			<div class="row">
          			<div class="panel panel-primary "><!--panel --> 
            			<div class="panel-heading ">
              				<h3 class="panel-title">Select Classroom</h3>
            			</div>
            			<div class="panel-body"><!--panel-body -->
              				<div class="row">
                				<div class="col-lg-3">
                                	<div class="form-group">
                                        ...
                                        <select class="form-control" style="width:200px;" id="classroom1" name="classroom">
...
<?php }} ?>                                    
    ...
    <!-- //MSK-xxxxx Modal-Upclassroom Confirm Popup -->
	<div class="modal msk-fade " id="upclassroomConfirm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
  		<div class="modal-dialog">
    		<div class="modal-content">
				<div class="modal-header bg-primary">
        			<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
				...
				<div class="modal-body bgColorWhite">
        			<strong style="color:red;">Are you sure?</strong>  Do you want to upclassroom this Student?
        		</div>
      			<div class="modal-footer">
...
$('body').on('click', '.confirm-upclassroom', function (e){	
//MSK-000129
    e.preventDefault();
    var index = $(this).data('id');
	
	$('#upclassroomConfirm').data('id', index).modal('show');//MSK-000130
...
//MSK-000133
	...
	var std_index=$('#upclassroomConfirm').data('id');
	...
	var xhttp = new XMLHttpRequest();//MSK-000134-Ajax Start  
  		...
  		xhttp.onreadystatechange = function() {
    		...
    		if (this.readyState == 4 && this.status == 200) {
				...
				if(myArray[0]==1){//MSK-000136
					...
					$("#upclassroomConfirm").modal('hide');	
					$('#modalSelectClassroom').data('id', std_index).modal('show');
    	...
    	xhttp.open("GET", "../model/delete_student_classroom_subject.php?index=" + std_index + "&page="+currentPage , true);												
  		xhttp.send();//MSK-000134-Ajax End
	
});

$('#classroom1').change(function () {
	//MSK-00123
	...
	var xhttp1 = new XMLHttpRequest();//MSK-000124-Start Ajax 
		...
		xhttp1.open("GET", "show_student_classroom_subject.php?id=" + classroom + "&do="+do1+ "&index="+index, true);												
		xhttp1.send();//MSK-000124-End Ajax
						
					
});
					
function upclassroomClassroom(){
...
function showModalClassroom(){
	...
	document.getElementById("classroom1").value ="Select Classroom";
...
$classroom=$_GET['classroom'];
	...
	if($msg==1){
		...
		echo '<script>','CPageClassroom('.$classroom.','.$page.');','</script>';
