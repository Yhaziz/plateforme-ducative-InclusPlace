            ...
            <div class="col-md-12">
              	<div class="box box-primary">
                	<div class="box-header with-border">
                        ...
                        <a href="all_student.php?do=showSTable&classroom_id=<?php echo $classroom_id; ?>" style="float:right" type="button" class="btn text-right btn-success asd" id="btnSubmit2"><span class="glyphicon glyphicon-arrow-left"></span> Back</a>
                	</div>
                   	<form role="form" action="../index.php" method="post"  enctype="multipart/form-data" id="form1" class="form-horizontal">
                		<div class="box-body" >
                        	<div class="row">
                        		<div class="col-md-6">
                                	<p class="alert-warning ">Student Details </p>
                                     <div class="form-group" id="divFullName">
                                        ...
                                        <div class="col-xs-9" id="divFullName1">
                                           <input type="text" class="form-control" placeholder="Enter full name" name="fname" id="fname" autocomplete="off" value="<?php echo $row['fname']; ?>">  
                                        </div>                    
                                    </div>
                                    <div class="form-group" id="divIName">
                                        ...
                                        <div class="col-xs-9" id="divIName1">
                                            <input type="text" class="form-control" placeholder="Enter name with initials" name="surname" id="surname" autocomplete="off" value="<?php echo $row['surname']; ?>">
                                        </div>                    
                                    </div>
                        				...
                        				<div class="col-xs-7">
                                            ...
                                            <div class="form-group" id="divtéléphone">
                                                ...
                                                <div class="col-xs-7" id="divtéléphone1">
                                                	<input type="text" class="form-control" id="téléphone" name="téléphone" value="<?php echo $row['téléphone']; ?>">
                                                </div> 
                                        	</div>  
                                            <div class="form-group" id="divDOB">
                                                ...
                                                <div class="col-xs-7" id="divDOB1">
                                                	<input type="date" class="form-control" id="b_date" name="b_date" value="<?php echo $row['b_date']; ?>">
                                                </div> 
                                        	</div>  
                                ...
                                <div class="col-md-6">
                                	<p class="alert-warning "> Parent Details </p>
                                     <div class="form-group" id="divGFullName">
                                        <div class="col-xs-3">
                                            <label for="exampleInputEmail1">Full Name</label>
                                        </div>
                                        <div class="col-xs-9" id="divGFullName1">
                                           <input type="text" class="form-control" placeholder="Enter full name" name="g_fname" id="g_fname" autocomplete="off" value="<?php echo $row1['fname']; ?>">  
                                        </div>                    
                                    </div>
                                    <div class="form-group" id="divGIName">
                                        ...
                                        <div class="col-xs-9" id="divGIName1">
                                            <input type="text" class="form-control" placeholder="Enter name with initials" name="g_surname" id="g_surname" autocomplete="off" value="<?php echo $row1['surname']; ?>">
                                        </div>                    
                                    </div>
                        				...
                        				<div class="col-xs-7">
                                            <div class="form-group" id="divGtéléphone">
                                                ...
                                                <div class="col-xs-7" id="divGtéléphone1">
                                                	<input type="text" class="form-control" id="g_téléphone" name="g_téléphone" value="<?php echo $row1['téléphone']; ?>" >
                                                </div> 
                                        	</div>
                                            <div class="form-group" id="divGDOB">
                                                ...
                                                <div class="col-xs-7" id="divGDOB1">
                                                	<input type="date" class="form-control" id="g_b_date" name="g_b_date" value="<?php echo $row1['b_date']; ?>">
                                                </div> 
                                        	</div> 
...
$("form").submit(function (e){
	...
	if(index_number == '' || g_index_number == '' || fname == '' || g_fname == '' || surname == '' || g_surname == '' || address == '' || g_address == '' || gender == 'Select Gender' || g_gender == 'Select Gender' || b_date == '' || g_b_date == '' || email == '' || mailformat.test(email) == false || g_email == '' || mailformat.test(g_email) == false || telformat.test(téléphone) == false || telformat.test(g_téléphone) == false || téléphone == ''  || g_téléphone == '' ) {
