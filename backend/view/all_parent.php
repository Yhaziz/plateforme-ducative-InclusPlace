...
?>   
                                <tr>
									...
									<td id="td4_<?php echo $row['id']; ?>"><?php echo $row['gender']; ?></td>
									<td id="td5_<?php echo $row['id']; ?>"><?php echo $row['troubles']; ?></td>
            		...
            		<div class="col-md-6">
                		<div class="panel">
        					<div class="panel-heading bg-orange">               
                    			...
                    			<h4 class="modal-title custom_align" id="Heading">Edit Parent</h4>
                			</div>
                			<form action="../index.php" method="post" enctype="multipart/form-data" id="form2">
								...
								<div class="form-group" id="divCinUpdate">
									...
									<div class="form-group">
                                        <label for="">What disorders does your child suffer from?</label>
                                        <select class="form-control" style="width:520px;" id="troubles1" name="troubles">
											<option >Select Type Of Disease</option>
                                            <option value="TSA">TSA (اضطراب طيف التوحد)</option>
											<option value="TDA">Troubles d'apprentissage (صعوبات التعلم)</option>
											<option value="TDH">TDH (فرط الحركة وتشتت الانتباه)</option>
                                        </select>
                                    </div>
                                ...
                                <div class="panel-footer bg-gray-light">
                                    ...
                                    <input type="hidden" name="do" value="update_parent">
	...
	var xhttp = new XMLHttpRequest();//MSK-00116-Ajax Start
  		xhttp.onreadystatechange = function() {
    		if (this.readyState == 4 && this.status == 200) {
				...
				document.getElementById("troubles1").value =myArray1[5];
    	...
    	xhttp.open("GET", "../model/get_parent.php?id=" + Id , true);//MSK-00116-Ajax End											
  		xhttp.send();
...
//MSK-000098-form2 submit
	...
	var troubles = document.getElementById("troubles1").value;
	...
	if(cin=='' || fname == '' || surname == '' || address == '' || téléphone == '' || email == '' || gname == '' || gaddress == '' || gtéléphone == '' || gemail == '' ||telformat.test(téléphone) == false || mailformat.test(email) == false ){
    		...
    		if (this.readyState == 4 && this.status == 200){//MSK-000134
				...
				if(myArray[0]==1){//MSK-000135
					...
					var xhttp1 = new XMLHttpRequest();//MSK-000136-Start Ajax  
						...
						xhttp1.open("GET", "show_parent_table.php" , true);												
...
function showModal1(Viewform){
    ...
    xhttp.open("GET", "../model/get_parnet.php?id=" + Id , true);												
