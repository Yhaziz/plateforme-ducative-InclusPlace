...
?>                        
            				<div class="">
								<a href="#" onClick="showFriends('<?php echo $my_type; ?>','Parent','<?php echo $my_index; ?>')" class="btn btn-md bg-red-active"  data-id=""><i class="fa fa-user-plus" aria-hidden="true">Parent</i></a>
								<a href="#" onClick="showFriends('<?php echo $my_type; ?>','Avs','<?php echo $my_index; ?>')" class="btn btn-md bg-yellow-active"  data-id=""><i class="fa fa-user-plus" aria-hidden="true">Avs</i></a>
								<a href="#" onClick="showFriends('<?php echo $my_type; ?>','Teacher','<?php echo $my_index; ?>')" class="btn btn-md bg-black-active"  data-id=""><i class="fa fa-user-plus" aria-hidden="true">Teachers</i></a> 
								<a href="#" onClick="showFriends('<?php echo $my_type; ?>','Doctor','<?php echo $my_index; ?>')" class="btn btn-md bg-blue-active"  data-id=""><i class="fa fa-user-plus" aria-hidden="true">Doctor</i></a> 
...
$sql="select student.index_number as std_index,student.surname as std_name,student.image_name as std_image,classroom.name as g_name
	  from student
	  inner join student_classroom
	  on student.index_number=student_classroom.index_number
	  inner join classroom
	  on student_classroom.classroom_id=classroom.id
	  where student.index_number!='$my_index' and student_classroom.year='$current_year'";
...
?>   
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <small>Student - <?php echo $classroom; ?></small>
                                        </td>
                                        <td>
								<?php 
