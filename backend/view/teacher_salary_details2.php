...
$sql="select classroom.name as g_name,classroom.hall_charge as h_charge,subject.name as s_name,subject_routing.fee as sr_fee,subject_routing.id as sr_id,subject_routing.classroom_id as g_id,subject_routing.subject_id as s_id
