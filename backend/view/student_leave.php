  		...
  		xhttp.onreadystatechange = function() {
    		...
    		if (this.readyState == 4 && this.status == 200) {
				...
				if(myArray1[0]==1){//MSK-000136
					...
					$('#modalSelectClassroom').data('id2',yourArray).modal('show');
...
$('#classroom').change(function () {
	...
	var myArray = $('#modalSelectClassroom').data("id2");
...
function showModalClassroom(){
	...
	document.getElementById("classroom").value ='Select Classroom';
};

function insertSubject(){
	//MSK-000131
	var Id = $("#checkbox").data("id");
	var classroom = $("#btnSubmit1").data("id");
    var yourArray = new Array();
	...
	var xhttp = new XMLHttpRequest();//MSK-000132-Start Ajax 
		...
		xhttp.open("GET", "student_first_payment.php?index=" + Id + "&classroom="+classroom + "&id="+JSON.stringify(yourArray), true);												
  		...
  		xhttp.onreadystatechange = function() {
    		...
    		if (this.readyState == 4 && this.status == 200) {//MSK-000142
				...
				if(myArray[0] == 1){//MSK-000144
					...
					var myArray5 = $('#modalSelectClassroom').data("id2");
					var page = myArray5[1];
