            			 ...
            			 <form role="form" action="../index.php" method="post">
            				<div class="panel-body"> <!-- Start of modal body--> 
                                ...
                                <div class="form-group" id="divUpdateClassroom">
        							...
        							<select class="form-control" id="classroom1" name="classroom_id"><!--MSK-000136-subject-->			
<?php
...
$sql="select DISTINCT subject_routing.classroom_id as g_id,classroom.name as g_name
...
<?php }} ?>	           
                                ...
                                <div class="form-group" id="divUpdatedisease">
        							...
        							<select class="form-control"  id="disease1" name="disease_id"><!--MSK-000136-disease-->			
<?php
include_once('../controller/config.php');
