...
include_once('../controller/config.php');
$id=$_GET['classroom'];	
$sql="select timetable.id as tt_id,timetable.start_time as tt_stime,timetable.end_time as tt_etime, subject.name as s_name,teacher.surname as t_name,disease.name as c_name
      from timetable
	  inner join subject
