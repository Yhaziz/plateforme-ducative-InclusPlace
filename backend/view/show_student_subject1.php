...
$sql1="select * from student_classroom where index_number='$index'";
$result1=mysqli_query($conn,$sql1);
$row1=mysqli_fetch_assoc($result1);
$id1=$row1['classroom_id'];
...
where subject_routing.classroom_id='$id1'";
...
<?php } } ?>                            
            			...
            			<div class="panel-footer bg-blue-active">
                            ...
                            <input type="hidden" id="classroom1" value="<?php echo $id1; ?>" >
