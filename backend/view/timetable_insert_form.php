...
<?php }} ?> 	           
								...
								<div class="form-group" id="divDisease">
        							...
        							<select class="form-control"  id="disease" name="disease_id"><!--MSK-000116-disease-->			
...
<?php }} ?> 	           
                                ...
                                <div class="form-group" id="divStartTime">
        							...
        							<input type="time" class="form-control" id="start_time" name="start_time"  placeholder="Enter start time" autocomplete="off"/>
        						</div>  
                                 <div class="form-group" id="divEndTime">
                					<label for="" >End Time</label>
        							<input type="time" class="form-control" id="end_time" name="end_time"  placeholder="Enter end time" autocomplete="off"/>
        						</div>  
            				</div><!--/.modal body-->
            				<div class="panel-footer bg-blue-active">
                            	<input type="hidden" id="classroom_id" name="classroom_id" value="<?php echo $id; ?>"  />
