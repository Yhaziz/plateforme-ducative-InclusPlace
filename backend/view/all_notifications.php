...
/*
$sql="select student.index_number as std_index,student.surname as std_name,payment_notifications.year as due_year,payment_notifications.month as due_month,payment_notifications.date as due_date
