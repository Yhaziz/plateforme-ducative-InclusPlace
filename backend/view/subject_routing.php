...
$("form").submit(function (e) {
	...
	if(classroom == 'Select Classroom' || subject == 'Select Subject' || teacher == 'Select Teacher' || fee == '' ){
...
<!-- //MSK-00103 Modal-modalUpdateform-->  
                    ...
                    <div class="col-md-3 ">
                        <div class="panel">
                            ...
                            <div class="panel-body"> <!-- Start of the modal body--> 
                                <div class="form-group" id="divClassroom1">
                                    <label for="" >Classroom</label>
    ...
    if(mysqli_num_rows($result) > 0){
        while($row=mysqli_fetch_assoc($result)){
    ?> 
                                        <option value="<?php echo $row["surname"]; ?>"><?php echo $row['surname']; ?></option>
    <?php }} ?>	          
                                    </select>
                                </div> 
	...
	var xhttp = new XMLHttpRequest();//MSK-00105-Ajax Start  
  		xhttp.onreadystatechange = function() {
			...
			if (this.readyState == 4 && this.status == 200) {
				...
				document.getElementById("classroom1").value =myArray1[1];
