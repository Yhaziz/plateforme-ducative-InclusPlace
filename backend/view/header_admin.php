...
<div class="wrapper">
  <header class="main-header" >
    ...
    <a href="dashboard.php" class="logo">
      ...
      <span class="logo-mini"><strong>INC</strong></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><strong>INCLUSPACE </strong></span>
    </a>
...
while($row=mysqli_fetch_assoc($result)){
	...
	if($_status=="Payments"){
		...
		$sql1="select student.index_number as std_index,student.surname as std_name,payment_notifications.month as due_month,payment_notifications.year as due_year,payment_notifications.id as notifi_id
...
?> 
            	...
            	<li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                      ...
                      <span class="hidden-xs"><?php echo $row['surname']; ?></span>
                    </a>
                    <ul class="dropdown-menu">
                      <!-- User image -->
                      <li class="user-header">
                        ...
                        <p>
                          <?php echo $row['surname']; ?> - <?php echo $type; ?>
                          <?php
                      ...
                      <li class="user-footer">
                        <div class="pull-left">
                          <a href="../view/admin_profile.php" class="btn btn-default btn-flat">Profile</a>
                        </div>
