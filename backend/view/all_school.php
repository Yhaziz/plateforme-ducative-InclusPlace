...
?>   
                                <tr>
									...
									<td id="td4_<?php echo $row['id']; ?>"><?php echo $row['téléphone']; ?></td>
									<td id="td5_<?php echo $row['id']; ?>"><img src="../<?php echo $row['image_name']; ?>" alt="Image" style="max-width: 80px; max-height: 80px;"></td>
                                    <td>
            		...
            		<div class="col-md-6">
                		<div class="panel">
        					<div class="panel-heading bg-orange">               
                    			...
                    			<h4 class="modal-title custom_align" id="Heading">Edit School</h4>
                			</div>
                                ...
                                <div class="panel-footer bg-gray-light">
                                    ...
                                    <input type="hidden" name="do" value="update_school">
	...
	var xhttp = new XMLHttpRequest();//MSK-00116-Ajax Start
  		xhttp.onreadystatechange = function() {
    		if (this.readyState == 4 && this.status == 200) {
				...
				var imagePath = path.concat(myArray1[5]);
			
				//MSK-00118
				document.getElementById("id1").value =myArray1[0];
				document.getElementById("fname1").value =myArray1[1];
				document.getElementById("address1").value =myArray1[2];
				document.getElementById("email1").value =myArray1[3];
				document.getElementById("téléphone1").value =myArray1[4];
				document.getElementById("output1").src ='../'+myArray1[5];
    	...
    	xhttp.open("GET", "../model/get_school.php?id=" + Id , true);//MSK-00116-Ajax End											
  		xhttp.send();
    		...
    		if (this.readyState == 4 && this.status == 200){//MSK-000134
				...
				if(myArray[0]==1){//MSK-000135
					...
					var xhttp1 = new XMLHttpRequest();//MSK-000136-Start Ajax  
						...
						xhttp1.open("GET", "show_school_table.php" , true);												
...
function showModal1(Viewform){
    ...
    xhttp.open("GET", "../model/get_school.php?id=" + Id , true);												
