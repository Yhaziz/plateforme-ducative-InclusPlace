...
$sql1="select classroom.name as g_name
       from student_classroom
	   inner join classroom
	   on student_classroom.classroom_id=classroom.id
	   where student_classroom.index_number='$index'"; 
$result1=mysqli_query($conn,$sql1);
$row1=mysqli_fetch_assoc($result1);
$classroom=$row1['g_name'];
...
?>                           
                        ...
                        <div class="panel-body"><!--panel-body -->
                            <div class="row">
                                ...
                                <h5>Classroom: <?php echo $classroom; ?> </h5>
...
while($row=mysqli_fetch_assoc($result)){
	...
	$sql1="select classroom.name as g_name,subject.name as s_name,subject_routing.fee as s_fee
