...
$sql="select student.index_number as std_index,student.surname as std_name,payment_notifications.month as due_month,payment_notifications.year as due_year,payment_notifications.id as notifi_id
...
$('body').on('click', '.confirm-delete-friend-req', function (e){
    ...
    e.preventDefault();
    var id = $(this).data('id');
	$('#deleteConfirmReq').data('id1', id).modal('show');
