...
$sql="select subject.name as s_name,subject.id as s_id,student_exam.marks as std_emark,student_exam.id as std_emark_id
	  ...
	  where student_exam.index_number='$std_index' and student_exam.year='$current_year' and student_exam.classroom_id='$classroom_id' and student_exam.exam_id='$exam_id'";	
