...
include_once("../controller/config.php");
	...
	$sql = "INSERT INTO student_classroom(index_number,classroom_id,year)
			VALUES ('".$index."','".$classroom_id."','".$year."')";
	mysqli_query($conn,$sql);
...
?>                                    
                                  <span class="std-name"><?php echo $row['fname']; ?></span><br>
                                  AV.Hedi Nouira <br>
                                  _ Immeuble jasmin médical 5ème étage B 502
<?php } ?>                                        
                                    </div>
                                </div>
...
$index=$_GET['index'];
$classroom_id=$_GET['classroom'];	
$sql1="select * from classroom where id='$classroom_id'";
                            ...
                            <div class="row">
                                <div class="col-xs-1 text-right pdetail1">
                                      <strong>
                                        ...
                                        <span id=""><?php echo $monthly_fee; ?>DT</span> <br>
