...
?>                                    
                                  <span class="std-name"><?php echo $row['surname']; ?></span><br>
                             ...
                             <table class="table table-bordered">
                                <thead>
                                    ...
                                    <th class="col-md-1">Amount(DT)</th>
                            ...
                            <div class="row">
                                <div class="col-xs-1 text-right pdetail1">
                                      <strong>
                                        <span id="spanmFee"><?php echo $monthly_fee; ?>DT</span> <br>
										<span id="spanTotal"><?php echo $paid; ?>DT</span> <br>
                                        <span id="spanPaid"><?php echo $paid; ?>DT</span> <br>
                                      </strong>
  								</div>
