...
?>   
                                <tr>
									...
									<td id="td5_<?php echo $row['id']; ?>"><?php echo $row['address']; ?></td>
                                    <td id="td6_<?php echo $row['id']; ?>"><?php echo $row['téléphone']; ?></td>
                                    <td id="td7_<?php echo $row['id']; ?>"><?php echo $row['email']; ?></td>
									<td id="td8_<?php echo $row['id']; ?>"> <img src="../<?php echo $row['image_name']; ?>" alt="Image" style="max-width: 80px; max-height: 80px;"></td>
                                    <td>
            		...
            		<div class="col-md-6">
                		<div class="panel">
        					<div class="panel-heading bg-orange">               
                    			...
                    			<h4 class="modal-title custom_align" id="Heading">Edit avs</h4>
                			</div>
                			<form action="../index.php" method="post" enctype="multipart/form-data" id="form2">
                                ...
                                <div class="panel-footer bg-gray-light">
                                    ...
                                    <input type="hidden" name="do" value="update_avs">
	...
	var xhttp = new XMLHttpRequest();//MSK-00116-Ajax Start
  		xhttp.onreadystatechange = function() {
    		if (this.readyState == 4 && this.status == 200) {
				...
				var imagePath = path.concat(myArray1[8]);
    	...
    	xhttp.open("GET", "../model/get_avs.php?id=" + Id , true);//MSK-00116-Ajax End											
  		xhttp.send();
    		...
    		if (this.readyState == 4 && this.status == 200){//MSK-000134
				...
				if(myArray[0]==1){//MSK-000135
					...
					var xhttp1 = new XMLHttpRequest();//MSK-000136-Start Ajax  
						...
						xhttp1.open("GET", "show_avs_table.php" , true);												
...
function showModal1(Viewform){
    ...
    xhttp.open("GET", "../model/get_avs.php?id=" + Id , true);												
