...
//MSK-000109
	...
	if(exam == 'Select Exam' || classroom == 'Select Classroom'){
    	...
    	xhttp.open("GET", "show_student.php?exam="+exam  +  "&year="+current_year+  "&my_index="+my_index +  "&classroom="+classroom , true);												
...
function showStudent1(exam,current_year,classroom){
	...
	var xhttp = new XMLHttpRequest();//MSK-000110-Start Ajax  
    	...
    	xhttp.open("GET", "show_student.php?exam="+exam  +  "&year="+current_year +  "&classroom="+classroom, true);												
  		xhttp.send();//MSK-000110-End Ajax
...
if(isset($_GET["do"])&&($_GET["do"]=="show_student_from_insert")){
	...
	if($msg > 0){
		...
		echo '<script>','showStudent1('.$exam.','.$current_year.','.$classroom.');','</script>';
...
function showModalAddExam(exam,std_index,classroom){
	...
	var xhttp = new XMLHttpRequest();//MSK-000110-Start Ajax  
    	...
    	xhttp.open("GET", "student_exam_mark_insert_form1.php?exam="+exam  + "&std_index="+std_index + "&classroom="+classroom + "&page="+currentPage, true);												
  		xhttp.send();//MSK-000110-End Ajax
};

function showModalEditExam(exam,std_index,classroom){
	...
	var xhttp = new XMLHttpRequest();//MSK-000110-Start Ajax  
    	...
    	xhttp.open("GET", "student_exam_mark_update_form.php?exam="+exam  + "&std_index="+std_index + "&classroom="+classroom, true);												
  		xhttp.send();//MSK-000110-End Ajax
};
