...
include_once('../controller/config.php');
$id=$_GET['classroom'];	
$sql="select timetable.id as tt_id,timetable.start_time as tt_stime,timetable.end_time as tt_etime, subject.name as s_name,teacher.surname as t_name,classroom.name as c_name
      from timetable
	  inner join subject
	  ...
	  on timetable.classroom_id=classroom.id
      where timetable.start_time='$s_time' and timetable.end_time='$e_time' and timetable.classroom_id='$id' and timetable.day='Sunday'";
...
?>    	
							...
							Teacher : <?php echo $row['t_name']; ?><br>
...
$sql="select timetable.id as tt_id,timetable.start_time as tt_stime,timetable.end_time as tt_etime, subject.name as s_name,teacher.surname as   t_name,classroom.name as c_name
	  ...
	  inner join classroom
	  on timetable.classroom_id=classroom.id
      where timetable.start_time='$s_time' and timetable.end_time='$e_time' and timetable.classroom_id='$id' and timetable.day='Monday'";
$result=mysqli_query($conn,$sql);
...
$sql="select timetable.id as tt_id,timetable.start_time as tt_stime,timetable.end_time as tt_etime, subject.name as s_name,teacher.surname as t_name,classroom.name as c_name
	  ...
	  inner join classroom
	  on timetable.classroom_id=classroom.id
      where timetable.start_time='$s_time' and timetable.end_time='$e_time' and timetable.classroom_id='$id' and timetable.day='Tuesday'";
$result=mysqli_query($conn,$sql);
...
$sql="select timetable.id as tt_id,timetable.start_time as tt_stime,timetable.end_time as tt_etime, subject.name as s_name,teacher.surname as t_name,classroom.name as c_name
	  ...
	  inner join classroom
	  on timetable.classroom_id=classroom.id
      where timetable.start_time='$s_time' and timetable.end_time='$e_time' and timetable.classroom_id='$id' and timetable.day='Wednesday'";
$result=mysqli_query($conn,$sql);
...
$sql="select timetable.id as tt_id,timetable.start_time as tt_stime,timetable.end_time as tt_etime, subject.name as s_name,teacher.surname as t_name,classroom.name as c_name
	  ...
	  inner join classroom
	  on timetable.classroom_id=classroom.id
      where timetable.start_time='$s_time' and timetable.end_time='$e_time' and timetable.classroom_id='$id' and timetable.day='Thursday'";
$result=mysqli_query($conn,$sql);
...
$sql="select timetable.id as tt_id,timetable.start_time as tt_stime,timetable.end_time as tt_etime, subject.name as s_name,teacher.surname as t_name,classroom.name as c_name
	  ...
	  inner join classroom
	  on timetable.classroom_id=classroom.id
      where timetable.start_time='$s_time' and timetable.end_time='$e_time' and timetable.classroom_id='$id' and timetable.day='Friday'";
$result=mysqli_query($conn,$sql);
...
$sql="select timetable.id as tt_id,timetable.start_time as tt_stime,timetable.end_time as tt_etime, subject.name as s_name,teacher.surname as t_name,classroom.name as c_name
	  ...
	  inner join classroom
	  on timetable.classroom_id=classroom.id
      where timetable.start_time='$s_time' and timetable.end_time='$e_time' and timetable.classroom_id='$id' and timetable.day='Saturday'";
