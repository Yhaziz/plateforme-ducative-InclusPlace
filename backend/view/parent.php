                ...
                <div class="box box-primary">
                    ...
                    <form role="form" action="../index.php" method="post"  enctype="multipart/form-data" id="form1" class="form-horizontal" >
                        <div class="box-body" >
							...
							<div class="form-group" id="divTroubles">
                                <div class="col-xs-3">
                                    <label>Type Of Disease</label>
                                </div>
                                <div class="col-xs-9" id="divTroubles1">
                                    <select name="troubles" class="form-control" id="troubles" >
                                            <option>What disorders does your child suffer from?</option>
                        ...
                        <div class="box-footer">
                            <input type="hidden" name="do" value="add_parent"  />
...
$("#form1").submit(function (e) {
	...
	if(fname == ''){
		...
		$('#divFname').append('<span id="spanFname" class="glyphicon glyphicon-remove form-control-feedback msk-set-width-tooltip" data-toggle="tooltip"    title="The full name is required" ></span>');	
	...
	if(troubles == 'Select troubles'){
		//MSK-00102-troubles
		$("#btnSubmit").attr("disabled", true);
		$('#divtroubles').addClass('has-error has-feedback');
		$('#divtroubles1').append('<span id="spantroubles" class="glyphicon glyphicon-remove form-control-feedback msk-set-width-tooltip" data-toggle="tooltip"    title="The troubles is required" ></span>');	
		
		$("#troubles").change(function() {
			//MSK-00103-troubles
			$("#btnSubmit").attr("disabled", false);	
			$('#divtroubles').removeClass('has-error has-feedback');
			$('#spantroubles').remove();
	...
	if(cin== '' || fname == '' || surname == '' || address == '' || gender == '' || troubles == '' || téléphone == '' || email == '' || mailformat.test(email) == false || telformat.test(téléphone) == false || photo == '' ){
