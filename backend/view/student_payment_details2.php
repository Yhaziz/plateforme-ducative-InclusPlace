...
$fname=$row['fname'];
?>                           
                            <h4 class="panel-title" id="tName"><?php echo $fname; ?></h4>
                                ...
                                <div class=" col-md-12 table1-responsive"> 
                                    ...
                                    <table class="table table-bordered table-striped">
                                        <thead>
                                            ...
                                            <th class="col-md-1">Subject Fee(DT)</th>
                                            <th class="col-md-1 ">Total(DT)</th>
                                        </thead>
                                        <tbody id="tBody">
<?php
include_once('../controller/config.php');
...
$sql="select classroom.name as g_name,subject.name as s_name,subject_routing.fee as sr_fee,subject_routing.id as sr_id,subject_routing.classroom_id as g_id,subject_routing.subject_id as s_id
