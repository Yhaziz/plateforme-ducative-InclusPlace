...
?>      
      ...
      <ul class="sidebar-menu">
        ...
        <li>
          <a href="disease.php">
            <i class="fa fa-list-ul"></i> <span>Disease</span>
          </a>
        </li>
        <li>
          <a href="classroom.php">
            <i class="fa fa-database"></i> <span>Classroom</span>
          </a>
        </li>
        <li>
          <a href="subject.php">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="school.php"><i class="fa fa-circle-o"></i> Add School</a></li>
            <li><a href="all_school.php"><i class="fa fa-circle-o"></i> All Scholl</a></li>
          </ul>
        </li>
        <li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="parent.php"><i class="fa fa-circle-o"></i> Add Parent</a></li>
            <li><a href="all_parent.php"><i class="fa fa-circle-o"></i> All Parent</a></li>
          </ul>
        </li>
        <li>
        ...
        <li class="treeview">
          <a href="#">
          <i class="fa-sharp fa-solid fa-hands-holding-child"></i>
            &nbsp;
            <span>Avs</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
          ...
          <ul class="treeview-menu">
            <li><a href="avs.php"><i class="fa fa-circle-o"></i> Add Avs</a></li>
            <li><a href="all_avs.php"><i class="fa fa-circle-o"></i> All Avs</a></li>
          </ul>
        </li>
        <li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="doctor.php"><i class="fa fa-circle-o"></i> Add Doctor</a></li>
            <li><a href="all_doctor.php"><i class="fa fa-circle-o"></i> All Docotr</a></li>
          </ul>
        </li>
        ...
        <li>
          <a href="contactmail.php">
            <i class="fa fa-envelope"></i> <span>Contact Email</span>
          </a>
        </li>
      </ul>
    </section>
