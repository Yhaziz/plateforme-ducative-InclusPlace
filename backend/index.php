...
if(isset($_arguments["do"])&& ($_arguments["do"] != "")){
	if(($_arguments["do"] == "add_disease")){
		$page = "model/add_disease.php";
	}else if(($_arguments["do"] == "add_classroom")){
	...
	}else if(($_arguments["do"] == "add_emarks_range_classroom")){
		$page = "model/add_emarks_range_classroom.php";
	...
	}else if(($_arguments["do"] == "update_avs_profile")){
		$page = "model/update_avs_profile.php";
	}else if(($_arguments["do"] == "add_group_message")){
		$page = "model/add_group_message.php";
	}else if(($_arguments["do"] == "add_school")){
		$page = "model/add_school.php";
	}else if(($_arguments["do"] == "update_school")){
		$page = "model/update_school.php";
	}else if(($_arguments["do"] == "add_parent")){
		$page = "model/add_parent.php";
	}else if(($_arguments["do"] == "update_parent")){
		$page = "model/update_parent.php";
	}else if(($_arguments["do"] == "add_avs")){
		$page = "model/add_avs.php";
	}else if(($_arguments["do"] == "update_avs")){
		$page = "model/update_avs.php";
	}else if(($_arguments["do"] == "add_doctor")){
		$page = "model/add_doctor.php";
	}else if(($_arguments["do"] == "update_doctor")){
		$page = "model/update_doctor.php";
	}
