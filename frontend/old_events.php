...
<body>
    ...
    <div class="container">
        ...
        <div class="class-wrapper">
                ...
                // Query for "old" events with category_id = 1
                $queryOld = "SELECT id, date_creation, title, start_time, end_time, start_date, end_date, location, image_name, end_date 
                            FROM events 
                            WHERE end_date < '$today' AND category_id = 1"; // Add the condition for category_id
                            ...
                            <div class="event-item">
                                <div class="event-thumb">
                                    <a href="events-single.php?id=<?php echo $row['id']; ?>">
                                        <img src="http://127.0.0.1/incluspace/backend/<?php echo $row['image_name']; ?>" alt="events">
                                    </a>
                                    <div class="date-tag">
