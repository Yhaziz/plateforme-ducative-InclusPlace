(function ($) {
  ...
  $(document).ready(function () {
    ...
    $('.first.circle').circleProgress({
      ...
      $(this).find('strong').php(Math.round(skillLevel1 * progress) + '<i>%</i>');
    });
    ...
    $('.second.circle').circleProgress({
      ...
      $(this).find('strong').php(Math.round(skillLevel2 * progress) + '<i>%</i>');
    });
    ...
    $('.third.circle').circleProgress({
      ...
      $(this).find('strong').php(Math.round(skillLevel3 * progress) + '<i>%</i>');
    });
