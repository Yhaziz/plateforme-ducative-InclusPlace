...
<!-- Mirrored from josekids.com/shop.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 27 Jul 2023 11:45:27 GMT -->
<head>
	<meta charset="UTF-8">
...
<body>
						...
						<ul class="menu">
							<li>
								...
								<ul class="submenu">
									...
									<li>
										<a href="index-3.php">Home Two</a>
									</li>
									<li>
										<a href="index-4.php">Home Three</a>
									</li>
								</ul>
							</li>
							<li>
							...
							<li>
								...
								<ul class="submenu">
									...
									<li>
										<a href="class-single.php">Class Single</a>
									</li>
									<li>
							...
							<li>
								...
								<ul class="submenu">
									...
									<li>
										<a href="blog-classic.php">Blog Classic</a>
									</li>
									<li>
							...
							<li>
								...
								<ul class="submenu">
									<li>
										...
										<ul class="submenu">
											<li>
												<a href="teacher.php">Our Teacher</a>
											</li>
											<li>
												<a href="teacher-single.php">Teacher Single</a>
											</li>
										</ul>
									</li>
									<li>
									...
									<li>
										...
										<ul class="submenu">
											<li>
												<a href="allevents.php">Our Events</a>
											</li>
											<li>
												<a href="events-single.php">Events Single</a>
											</li>
										</ul>
									</li>
									<li>
									...
									<li>
										...
										<ul class="submenu">
											<li>
												<a href="gallery.php">Gallery One</a>
											</li>
											<li>
												<a href="gallery-2.php">Gallery Two</a>
											</li>
											<li>
												<a href="gallery-3.php">Gallery Three</a>
											</li>
										</ul>
									</li>
									<li>
									...
									<li>
										<a href="error-page.php">404 Error</a>
									</li>
								</ul>
							</li>
							<li>
	...
	<section class="page-header bg_img" data-background="assets/images/banner/page-header.php">
		<div class="container">
			<div class="page-header-content">
				<h1 class="title">Our Product Page</h1>
				<ul class="breadcrumb">
					<li>
				...
				<div class="col-lg-8 col-xl-9 mb-50">
					...
					<div class="shop-product-wrap grid row mb-30-none">
						<div class="col-xl-4 col-md-6">
							<div class="shop-item">
								...
								<div class="product-content">
									<h5 class="title"><a href="shop-single.php">Baby Bags</a></h5>
									<p>
										<i class="far fa-star"></i><i class="far fa-star"></i><i
											class="far fa-star"></i><i class="far fa-star"></i><i
											class="far fa-star"></i> <span>(3 review)</span>
									</p>
									<h6 class="subtitle">$200</h6>
								</div>
							</div>
						...
						<div class="col-xl-4 col-md-6">
							<div class="shop-item">
								<div class="product-thumb">
									<img src="assets/images/shop/07.png" alt="shop">
									<div class="product-action-link">
										<a class="view-modal" data-target="#quick_view"><i class="far fa-eye"></i></a>
										<a href="#"><i class="far fa-heart"></i></a>
										<a href="#"><i class="fas fa-cart-plus"></i></a>
						...
						<div class="col-xl-4 col-md-6">
							<div class="shop-item">
								<div class="product-thumb">
									<img src="assets/images/shop/08.png" alt="shop">
									<div class="product-action-link">
										<a class="view-modal" data-target="#quick_view"><i class="far fa-eye"></i></a>
										<a href="#"><i class="far fa-heart"></i></a>
										<a href="#"><i class="fas fa-cart-plus"></i></a>
						...
						<div class="col-xl-4 col-md-6">
							<div class="shop-item">
								<div class="product-thumb">
									<img src="assets/images/shop/09.png" alt="shop">
									<div class="product-action-link">
										<a class="view-modal" data-target="#quick_view"><i class="far fa-eye"></i></a>
										<a href="#"><i class="far fa-heart"></i></a>
										<a href="#"><i class="fas fa-cart-plus"></i></a>
						...
						<div class="widget widget-product">
							...
							<div class="widget-body">
								<ul>
									<li>
										<div class="product-thumb">
											<a href="#"><img src="assets/images/shop/01.jpg" alt="shop"></a>
										</div>
										<div class="product-content">
											<h6><a href="shop-single.php">Baby Bags</a></h6>
											<p>
												<i class="far fa-star"></i><i class="far fa-star"></i><i
													class="far fa-star"></i><i class="far fa-star"></i><i
													class="far fa-star"></i> <span>(3 review)</span>
									...
									<li>
										<div class="product-thumb">
											<a href="#"><img src="assets/images/shop/02.jpg" alt="shop"></a>
										</div>
										<div class="product-content">
											<h6><a href="shop-single.php">Baby Bags</a></h6>
											<p>
									...
									<li>
										<div class="product-thumb">
											<a href="#"><img src="assets/images/shop/03.jpg" alt="shop"></a>
										</div>
										<div class="product-content">
											<h6><a href="shop-single.php">Baby Bags</a></h6>
											<p>
									...
									<li>
										<div class="product-thumb">
											<a href="#"><img src="assets/images/shop/04.jpg" alt="shop"></a>
										</div>
										<div class="product-content">
											<h6><a href="shop-single.php">Baby Bags</a></h6>
											<p>
	...
	<footer class="bg_img" data-background="assets/images/footer/footer-bg.jpg">
		...
		<div class="footer-bottom">
			<div class="container">
				<p>
					&copy; 2022 All Rights Reserved. Designed by <a
						href="https://themeforest.net/user/labartisan/portfolio" target="_blank">LabArtisan</a>
				</p>
			</div>
		</div>
	</footer>
...
<!-- Mirrored from josekids.com/shop.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 27 Jul 2023 11:45:31 GMT -->
</html>