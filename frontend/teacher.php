...
<body>
    ...
    <section class="page-header bg_img" data-background="assets/images/banner/page-header.jpg">
        <div class="container">
            <div class="page-header-content">
                <h1 class="title">Our Best Teachers</h1>
                <ul class="breadcrumb">
                    <li>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="teacher-item-2">
                        <div class="teacher-thumb">
                            ...
                            <div class="content">
                                <h5 class="title"><a href="teacher-single.php">Jason Kovalsky</a></h5>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="teacher-item-2">
                        <div class="teacher-thumb">
                            ...
                            <div class="content">
                                <h5 class="title"><a href="teacher-single.php">Bangile Yusha</a></h5>
                                <span>Spanish Teacher</span>
                            </div>
                        </div>
                        <div class="teacher-content">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="teacher-item-2">
                        <div class="teacher-thumb">
                            ...
                            <div class="content">
                                <h5 class="title"><a href="teacher-single.php">Willium Kovalsky</a></h5>
                                <span>Spanish Teacher</span>
                            </div>
                        </div>
                        <div class="teacher-content">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="teacher-item-2">
                        <div class="teacher-thumb">
                            ...
                            <div class="content">
                                <h5 class="title"><a href="teacher-single.php">Bini Zaara</a></h5>
                                <span>Spanish Teacher</span>
                            </div>
                        </div>
                        <div class="teacher-content">
        ...
        <div class="container">
            <div class="call-wrapper">
                ...
                <div class="text-center">
                    <a href="teacher-single.php" class="custom-button"><span>Get Started Now</span></a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="teacher-section padding-bottom padding-top bg_img"
        data-background="assets/images/teacher/teacher-bg.php">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="section-header">
                        ...
                        <div class="teacher-inner">
                            <div class="teacher-thumb">
                                <div class="thumb-inner">
                                    <a href="teacher-single.php"><img src="assets/images/teacher/teacher01.jpg"
                                            alt="teacher"></a>
                                </div>
                            </div>
                            <div class="teacher-content">
                                <h6 class="title"><a href="teacher-single.php">Alison Tylor</a></h6>
                ...
                <div class="col-lg-6">
                    <div class="teacher-item">
                        <div class="teacher-inner">
                            <div class="teacher-thumb">
                                <div class="thumb-inner">
                                    <a href="teacher-single.php"><img src="assets/images/teacher/teacher02.jpg"
                                            alt="teacher"></a>
                                </div>
                            </div>
                            <div class="teacher-content">
                                <h6 class="title"><a href="teacher-single.php">Robot Smith</a></h6>
                                <span class="info">Spanish Teacher</span>
                                <p>Samet consectetuer apiscing elitsed diam nonumy nibh euismod nciduns awesome team
                                    mumber</p>
                                <ul class="teacher-social">
                ...
                <div class="col-lg-6">
                    <div class="teacher-item">
                        <div class="teacher-inner">
                            <div class="teacher-thumb">
                                <div class="thumb-inner">
                                    <a href="teacher-single.php"><img src="assets/images/teacher/teacher03.jpg"
                                            alt="teacher"></a>
                                </div>
                            </div>
                            <div class="teacher-content">
                                <h6 class="title"><a href="teacher-single.php">Dillon Harper</a></h6>
                                <span class="info">Spanish Teacher</span>
                                <p>Samet consectetuer apiscing elitsed diam nonumy nibh euismod nciduns awesome team
                                    mumber</p>
                                <ul class="teacher-social">
                ...
                <div class="col-lg-6">
                    <div class="teacher-item">
                        <div class="teacher-inner">
                            <div class="teacher-thumb">
                                <div class="thumb-inner">
                                    <a href="teacher-single.php"><img src="assets/images/teacher/teacher04.jpg"
                                            alt="teacher"></a>
                                </div>
                            </div>
                            <div class="teacher-content">
                                <h6 class="title"><a href="teacher-single.php">De Yong</a></h6>
                                <span class="info">Spanish Teacher</span>
                                <p>Samet consectetuer apiscing elitsed diam nonumy nibh euismod nciduns awesome team
                                    mumber</p>
                                <ul class="teacher-social">
